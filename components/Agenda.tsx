const items = [
  ...
  { time: "", title: "William Faithfull, PhD — ExaDev (Talk)", desc: "\"Does OpenClaw make AI SaaS redundant?\" — A provocation from the CEO of ExaDev.", icon: "🤔" },
  { time: "", title: "Halima Yasmin — TigerFlow AI (Keynote)", desc: "\"From GoHighLevel to Proprietary AI: Building TigerFlow AI for UK Real Estate\" — A deep dive into building a bespoke AI platform for the UK property market. 20–25 min keynote.", icon: "🐯" },
  { time: "", title: "Lewis Crawford (Equal Experts) — Agent-oriented architecture", desc: "Lewis is the founding member of the Office of AI at Equal Experts.", icon: "🏗️" },
