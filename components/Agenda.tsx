const items = [
  ...
  { time: "~7:55 PM", title: "Andy Gray — Live Show-and-Tell", desc: "How I taught Garfield to use OpenClaw to do the annoying tasks in my life — a 5-minute live demo.", icon: "🐱" },
