const items = [
  ...
  { time: "7:00 PM", title: "William Faithfull, PhD — ExaDev (Talk)", desc: "\"Does OpenClaw make AI SaaS redundant?\" — A provocation from the CEO of ExaDev.", icon: "🤔" },
  { time: "7:30 PM", title: "Halima Yasmin — TigerFlow AI (Keynote)", desc: "\"From GoHighLevel to Proprietary AI: Building TigerFlow AI for UK Real Estate\" — A deep dive into building a bespoke AI platform for the UK property market. 20–25 min keynote.", icon: "🐯" },
  { time: "~7:50 PM", title: "Lewis Crawford (Equal Experts) — Agent-oriented architecture", desc: "Lewis is the founding member of the Office of AI at Equal Experts.", icon: "🏗️" },
  { time: "", title: "Toby Remond — OptiBee (Lightning Talk)", desc: "\"From OpenClaw to AI Operating System: How I Built a 10x Productivity Layer for My Business\" — 5 minutes on building an AI-first consultancy in Manchester.", icon: "🐝" },
