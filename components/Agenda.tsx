const items = [
  ...
  { time: "~8:10 PM", title: "Matt — MongoDB (Lightning Talk)", desc: "A 5-minute lightning talk from MongoDB's Principal Technologist. Topic TBC.", icon: "⚡" },
  { time: "~8:15 PM", title: "William Faithfull — ExaDev (Lightning Talk)", desc: "A 10–15 minute talk from ExaDev's CEO. Topic TBC.", icon: "⚡" },
  { time: "8:30 – 9:00 PM", title: "Open Networking", desc: "More connections, more conversations — stay sharp, stay curious.", icon: "🤝" },
